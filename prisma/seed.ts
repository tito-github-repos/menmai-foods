...
async function main() {
  ...
  const chapathi = await prisma.product.upsert({
    ...
    update: {
      ...
      netWeight: "450g",
      pieces: 10,
      imageUrl: "/img/products/chapathi_main.png",
      stockQuantity: 100,
      isActive: true,
    },
    create: {
  ...
  const poori = await prisma.product.upsert({
    ...
    update: {
      ...
      netWeight: "500g",
      pieces: 15,
      imageUrl: "/img/products/poori_main.png",
      stockQuantity: 100,
      isActive: true,
    },
    create: {
  ...
  await prisma.productImage.upsert({
    ...
    update: {
      ...
      imageUrl: "/img/products/chapathi1.jpeg",
  ...
  await prisma.productImage.upsert({
    ...
    update: {
      productId: chapathi.id,
      imageUrl: "/img/products/chapathi2.jpeg",
  ...
  await prisma.productImage.upsert({
    ...
    update: {
      productId: poori.id,
      imageUrl: "/img/products/poori1.jpeg",
  ...
  await prisma.productImage.upsert({
    ...
    update: {
      productId: poori.id,
      imageUrl: "/img/products/poori2.jpeg",
