...
export default function BulkOrderPage() {
  ...
  const handleBulkOrderSubmit = async () => {
    ...
    if (pincodeServiceable === false) {
      newErrors.pincode = "We're expanding soon and will be delivering to your area shortly.";
    }
    setErrors(newErrors);
                      ...
                      <TextField
                        ...
                        onChange={async (e) => {
                          ...
                          try {
                            ...
                            setErrors((prev) => ({
                              ...prev,
                              pincode: data.serviceable ? undefined : "We're expanding soon and will be delivering to your area shortly.",
                            }));
                          } finally {
