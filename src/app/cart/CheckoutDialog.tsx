  ...
  return (
    <>
        ...
        >
          ...
          >
            ...
            <Button
              ...
              variant="contained"
              disabled={
                loading || (step === "address" && !isPincodeServiceable)
              }
              sx={{
                mt: { xs: 2.5, sm: 3 },
                py: { xs: 1.4, sm: 1.7 },
                  ...
                  if (step === "mobile") {
                    ...
                    const options = {
                      ...
                      handler: async function (response: any) {
                        ...
                        const addressString = `${form.address}, ${form.city}, ${form.pincode}`;
                        ...
                        window.location.href =
                          ...
                          `&deliveryAddress=${encodeURIComponent(addressString)}`;
                      },
      ...
      <FullScreenLoader
        ...
        message="Please wait while we confirm your order. Don't close or refresh this page."
      />
    </>
  );
}
